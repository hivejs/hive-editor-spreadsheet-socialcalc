/**
 * gulf binding for SocialCalc spreadsheet editor (using ot-spreadsheet)
...
var gulf = require('gulf')
  , spreadsheetOT = require('./ot-spreadsheet')
...
module.exports = function(socialCalcControl) {
  ...
  doc._change = function(changes, cb) {
    ...
    socialCalcControl.sheet.ScheduleSheetCommands(cmds)
  ...
  SocialCalc.Callbacks.broadcast = function(type, data) {
    ...
    var changes = spreadsheetOT.deserializeEdit(data.cmdstring)
    doc.update(changes)
  }
